...
from lenet_Architecture.lenet import LeNet
...
for imagePath in imagePaths:
    ...
    label = 1 if label == "Hoodies" else 0
    labels.append(label)
...
model.save("../../Models/hoodie_not_hoodie.model")
...
plt.title("Training Loss and Accuracy on Hoodie identification")
plt.xlabel("Epoch #")
